def add_parser(parser):
    parser.add_argument('--dataset_path', type=str, default='/media/ubuntu/DATA/dy/data/multidata', help='dataset path')
    parser.add_argument('--images_dir', type=str, default='/media/ubuntu/DATA/dy/data/image_small', help='dataset path')
    ...
    parser.add_argument('--d_conv', type=int, default=4, help='d_conv parameter of Mamba')
    ...
    parser.add_argument('--target1', type=str, default='accel', help='target feature')
    parser.add_argument('--target2', type=str, default='friction', help='target feature')
    ...
    # model saving path
    parser.add_argument('--checkpoints', type=str, default='/media/ubuntu/DATA/dy/multi-bimamba/dcheckpoints',
                        help='location of model checkpoints')
    parser.add_argument('--results', type=str, default='/media/ubuntu/DATA/dy/multi-bimamba/results',
                        help='location of model results')
    parser.add_argument('--predictions', type=str, default='/media/ubuntu/DATA/dy/multi-bimamba/predictions',
                        help='location of model predictions')
    parser.add_argument('--datasave', type=str, default='/media/ubuntu/DATA/dy/multi-bimamba/datasave', help='data save')
    ...
    parser.add_argument('--train_epochs', type=int, default=4000, help='train epochs')
    ...
    parser.add_argument('--stride', type=int, default=1, help='stride, half or full length of patch_len')
    ...
    parser.add_argument('--pos_embed_type', type=str, default='sincos',
                        help='how do you generate positional encoding for Encoder')
